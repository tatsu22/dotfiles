...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      local telescope_ignore = function()
      ...
      telescope_ignore()
      vim.keymap.set('n', '<leader>si', telescope_ignore, { noremap = true, desc = 'Toggle telescope ignore patterns' })
    end,
  },
  ...
  { -- Autocompletion
    ...
    opts = {
      ...
      sources = {
        default = { 'lsp', 'path', 'snippets', 'minuet', 'lazydev' },
        providers = {
          minuet = {
            name = 'minuet',
            module = 'minuet.blink',
